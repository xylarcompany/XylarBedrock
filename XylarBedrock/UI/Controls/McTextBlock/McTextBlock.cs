...
namespace XylarBedrock.UI.Controls.McTextBlock {
    public class McTextBlock : FrameworkElement {
        ...
        private void EnsureFormattedText() {
            ...
            IsAnimated = false; //Wird in RemoveCodes() auf true gesetzt, falls irgendwas tatsÃ¤chlcih effektiv obfuscated ist
