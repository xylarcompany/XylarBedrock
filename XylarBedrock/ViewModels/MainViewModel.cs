...
namespace XylarBedrock.ViewModels
{
    ...
    public class MainViewModel : IDialogHander, ILauncherModel, IBackwardsCommunication
    {
        ...
        public async void LauncherCanNotCloseDialog(Action successAction)
        {
            ...
            {
                var title = XylarBedrock.Localization.Language.LanguageManager.GetResource("Dialog_CloseGame_Title") as string;
                var content = XylarBedrock.Localization.Language.LanguageManager.GetResource("Dialog_CloseGame_Text") as string;
